...
class PegawaiController extends Controller
{
    ...
    public function store_pegawai(Request $request){
        ...
        $save = DB::table('pegawai')->insert([
            ...
            if($save){
                return redirect('/data_pegawai')->with('sukses', 'Data berhasil ditambahkan');
            }
    }
    ...
    public function hapus_pegawai(Request $request){
        ...
        return redirect('/data_pegawai')->with('hapus', 'Data pegawai berhasil dihapus');
    }
    ...
    public function update_pegawai(Request $request){
        ...
        return redirect('/data_pegawai')->with('update', 'Data pegawai berhasil diupdate');
    }
