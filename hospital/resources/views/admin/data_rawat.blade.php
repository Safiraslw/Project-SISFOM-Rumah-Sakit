				...
				<div class="card-body">
					<form method="post" action="/cari_rawat">
						...
						<div class="input-group mb-4">
							...
							<button type="submit" class="btn" style="background-color:#8caca2;">Cari</button>
						</div>
					</form>
					<a href="/tambah_datarawat" class="btn mb-3" style="background-color:#8caca2;">Tambah</a>
