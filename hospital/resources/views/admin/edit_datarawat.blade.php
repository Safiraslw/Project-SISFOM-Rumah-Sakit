		...
		<form method="post" action="/update_datarawat">
			...
			<div class="mb-3">
				...
				<select name="tipe" class="form-control" id="tipe">
					<option value="Rawat Inap" <?php if ($data->tipe == 'Rawat Inap') {
													echo 'selected';
												} ?>>Rawat Inap</option>
					<option value="Rawat Jalan" <?php if ($data->tipe == 'Rawat Jalan') {
													echo 'selected';
												} ?>>Rawat Jalan</option>
				</select>
			</div>
			...
			<button type="submit" class="btn" style="background-color:#8caca2;"></i>Update</button>
		</form>
	</div>
	<!--/div-->
</div>
