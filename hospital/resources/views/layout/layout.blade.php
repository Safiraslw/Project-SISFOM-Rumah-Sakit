...
<body class="main-body light-theme app sidebar-mini active leftmenu-color" style="background-color: #F5F1EA;">
	...
	<aside class="app-sidebar" style="background-color:#8caca2;">
		...
		<div class="main-sidemenu sidebar-scroll">
			<ul class="side-menu">
				<li class="slide">
					<a class="side-menu__item" style="background-color:#8caca2;" href="/data_pegawai">
			...
			<div class="app-sidefooter" style="background-color:#8caca2;">
				<a class="side-menu__item" href="/logout">
					<svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24">
						<g>
			...
			<div class="container-fluid">
				...
				<div class="main-header-right">
					<div class="nav nav-item  navbar-nav-right ml-auto">
						<div class="">
							<img class="avatar br round mx-auto text-center" src="https://github.com/Safiraslw.png">
						</div>
					</div>
				</div>
			</div>
